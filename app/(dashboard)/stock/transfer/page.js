...
import { Plus, Search, ChevronDown, Calendar, ArrowRight, X, Package } from "lucide-react";
...
export default function ProductTransfer() {
  ...
  const transfers = [
    { date: "2026-05-15", product: "Rod 16mm", qty: 2, unit: "Tons", from: "Project Delta", to: "Project Alpha" },
    { date: "2026-05-14", product: "Cement", qty: 100, unit: "Bags", from: "Project Sigma", to: "Project Delta" },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Product Transfer</h1>
          <p className="text-slate-500 text-sm mt-1">Transfer materials between projects.</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-900 text-white">
                ...
                <th className="py-4 px-6 text-sm font-medium">From Project</th>
                <th className="py-4 px-6 text-sm font-medium">To Project</th>
              </tr>
            </thead>
            <tbody>
              {transfers.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-6 text-sm text-slate-500">{item.from}</td>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
            ...
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold text-slate-900">New Product Transfer</h2>
                <p className="text-slate-500 text-sm mt-0.5">Move materials from one project to another.</p>
              </div>
              <button 
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">From Project *</label>
                  <div className="relative">
                    <select
                      className="w-full appearance-none bg-slate-50 border border-slate-200 rounded-lg py-2.5 pl-4 pr-10 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent cursor-pointer"
                    >
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">To Project *</label>
                  <div className="relative">
                    <select
                      className="w-full appearance-none bg-slate-50 border border-slate-200 rounded-lg py-2.5 pl-4 pr-10 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent cursor-pointer"
                    >
