...
import { Plus, Search, ChevronDown, X, Package, Layers } from "lucide-react";
...
export default function ProductManagement() {
  ...
  const products = [
    { name: "Rod 16mm", unit: "Tons", category: "Steel", status: "Active" },
    { name: "Cement", unit: "Bags", category: "Binding", status: "Active" },
    { name: "Sand", unit: "Cft", category: "Fill", status: "Active" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage products/materials for your projects.</p>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-900 text-white">
                <th className="py-4 px-6 text-sm font-medium">Product Name</th>
            ...
            <tbody>
              {products.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-6 text-sm text-slate-700">{item.category}</td>
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
            ...
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-500 text-sm mt-0.5">Define a new material/product.</p>
              </div>
              <button 
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder="e.g. Masonry, Finishing"
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg py-2.5 px-4 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                  <div className="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400">
                    <Layers size={16} />
